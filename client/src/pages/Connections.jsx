...
const Connections = () => {
    ...
    const currentTabContent = dataArray.find((item) => item.label === currentTab);
                ...
                return (
                    <>
                        <button
                            ...
                            className='w-full p-2 text-sm rounded bg-indigo-500 text-white hover:bg-indigo-600 active:scale-95 transition cursor-pointer'
                        >
                            Accept
                        </button>
                        <button
                            onClick={handleDecline}
                            className='w-full p-2 text-sm rounded bg-gray-300 text-gray-800 hover:bg-gray-400 active:scale-95 transition cursor-pointer'
                        >
                            Decline
                        </button>
                    </>
        ...
        <div className='min-h-screen bg-slate-50'>
            <div className='max-w-6xl mx-auto p-6'>
                ...
                <div className='flex flex-wrap gap-6 mt-6'>
                    {currentTabContent?.value.map((user) => (
                        <div key={user._id} className='w-full max-w-88 flex flex-wrap gap-5 p-6 bg-white shadow rounded-md'>
                            <img
